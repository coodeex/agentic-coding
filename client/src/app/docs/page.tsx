      ...
      <main className="flex min-h-screen w-full max-w-4xl flex-col justify-between py-16 px-6 sm:px-8 lg:px-16">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl">
            A comprehensive guide to the Agentic Coding project and how to get
            started.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-12">
          ...
          <section className="space-y-4">
            ...
            <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed max-w-2xl">
              Agentic Coding is a collection of notes, ideas, and experiments
              exploring how Claude can be used as an AI coding agent to automate
              development workflows and improve productivity.
            </p>
            <p className="text-base text-zinc-700 dark:text-zinc-300 leading-relaxed max-w-2xl">
              This project tests how Claude can analyze issues, plan solutions,
              implement fixes, run tests, and manage the entire development
              workflow autonomously using custom commands and automation
              patterns.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="space-y-2">
              {[
                {
                  name: 'Next.js 16',
                  description: 'React framework with TypeScript support',
                },
                {
                  name: 'React 19',
                ...
                {
                  name: 'Tailwind CSS 4',
                  description: 'Utility-first CSS framework with PostCSS',
                },
                {
                  name: 'ESLint 9',
                  description: 'JavaScript linting for code quality',
                },
              ].map((tech, index) => (
                <li
                  key={index}
...
pnpm lint -- --fix`}
              ...
              <div>
                ...
                <p className="text-base text-zinc-700 dark:text-zinc-300 mb-2">
                  ...
                  command is available for automated workflow:
                </p>
                <ul className="space-y-2 ml-6">
                  ...
                  <li className="text-base text-zinc-700 dark:text-zinc-300">
                    • Appends a summary to the daily log file
                  </li>
                  <li className="text-base text-zinc-700 dark:text-zinc-300">
                    • Generates and commits with a concise message
                  </li>
                  <li className="text-base text-zinc-700 dark:text-zinc-300">
                    • Pushes to remote
                  </li>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base text-zinc-700 dark:text-zinc-300 mb-3">
                  Multiple Claude instances can work in parallel using git
                  worktrees. This lightweight approach enables concurrent
                  development:
                </p>
                <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg overflow-auto">
                  <pre className="text-sm text-zinc-800 dark:text-zinc-200 font-mono">
              ...
              {[
                {
                  ...
                  desc: 'Define reusable command templates in .claude/commands/ for repetitive workflows',
                },
                {
                  title: 'Tool Permissions',
                  desc: 'Curate which tools Claude can use via /permissions command for enhanced security',
                },
                {
                  title: 'Desktop Notifications',
                  desc: 'Get alerts when Claude needs user input for faster interaction',
                },
                {
                  title: 'Git Integration',
                  desc: 'Use Claude to manage git operations, resolve conflicts, and review changes',
                },
                {
                  title: 'Plan Mode',
                  desc: 'Press Shift+Tab to switch into planning mode for architecting solutions before coding',
                },
                {
                  title: 'Context Management',
                  desc: 'Use /reset command to keep context focused during long development sessions',
                },
              ].map((feature, index) => (
                <div
                  key={index}
          ...
          <section className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-base text-zinc-700 dark:text-zinc-300">
                ...
                command in Claude Code for built-in help
              </li>
              <li className="text-base text-zinc-700 dark:text-zinc-300">
                • Check the{' '}
                <code className="bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded text-sm">
                ...
                file for project-specific guidance
              </li>
              <li className="text-base text-zinc-700 dark:text-zinc-300">
